...
import yamlargparse
import logging
from SVS.model.train_joint import train_joint
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--initmodel_generator", default="", help="Initialize the model from given file"
    )
    parser.add_argument(
        "--initmodel_predictor", default="", help="Initialize the model from given file"
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.3,
        help="The predictor_weight for predictor when calculate loss in joint-training period",
    )
